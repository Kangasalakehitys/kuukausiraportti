...
//Data
export const kvaa_pxt_12g2 = (await FileAttachment("../../data/stat/vaalit/kvaa_pxt_12g2.json")
            .json())
                .map(d => ({
                    ...d, 
...
export const kvaa_pxt_12g3 = (await FileAttachment("../../data/stat/vaalit/kvaa_pxt_12g3.json")
            .json())
                .map(d => ({
                    ...d, 
                    xColumn: new Date(d.data.xColumn),

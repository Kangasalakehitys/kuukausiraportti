...
//Data
export const hopea_varak_12hk = (await FileAttachment("../../data/stat/vaesto/hopea_varak_12hk.json")
            .json())
                .map(d => ({
                    ...d, 
                    //Alue
...
export const hopea_varak_12hk_tilasto = (await FileAttachment("../../data/stat/vaesto/hopea_varak_12hk.json")
.json())
    .map(d => ({
        ...d, 
        //Alue

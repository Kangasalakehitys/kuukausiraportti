//node /Users/kanga/Documents/Observable/testi/src/data/stat/vaesto/vaenn_14wx.json.js
import {KUNTA_ID} from "../../../variables/variables.js";
import {utcFormat} from "d3-time-format";

const URL = "https://pxdata.stat.fi:443/PxWeb/api/v1/fi/StatFin/vaenn/statfin_vaenn_pxt_14wx.px"
...
.then(responseData =>
  responseData.data.map(f => ({
    xColumn_1: f.key[0],
    xColumn_2: formatTime(new Date(f.key[1])),
    xColumn_3: f.key[2],
    xColumn_4: f.key[3],

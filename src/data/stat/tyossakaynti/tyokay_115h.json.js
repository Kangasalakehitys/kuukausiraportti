//node /Users/kanga/Documents/Observable/testi/src/data/stat/tyossakaynti/tyokay_115h.json.js
import {KUNTA_ID} from "../../../variables/variables.js";
import {utcFormat} from "d3-time-format";

const URL = "https://pxdata.stat.fi:443/PxWeb/api/v1/fi/StatFin/tyokay/statfin_tyokay_pxt_115h.px"
const kunta_id = KUNTA_ID



const QUERY1 = '{ "code": "Työpaikan alue", "selection": { "filter": "item", "values": ["KU'+ kunta_id +'"] } },';
...
.then(responseData =>
  responseData.data.map(f => ({
    xColumn_1: f.key[1],
    xColumn_2: formatTime(new Date(f.key[3])),

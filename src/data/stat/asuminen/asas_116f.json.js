//node /Users/kanga/Documents/Observable/testi/src/data/stat/asuminen/asas_116f.json.js
import {KUNTA_ID} from "../../../variables/variables.js";
import {utcFormat} from "d3-time-format";

const URL = "https://pxdata.stat.fi:443/PxWeb/api/v1/fi/StatFin/asas/statfin_asas_pxt_116f.px"
const kunta_id = KUNTA_ID



const QUERY1 = '{ "code": "Alue", "selection": { "filter": "item", "values": ["KU'+ kunta_id +'"] } },';
const QUERY2 = '{ "code": "Talotyyppi", "selection": { "filter": "item", "values": [ "SSS","1","2","3","4" ] } },';
...
.then(responseData =>
  responseData.data.map(f => ({
    xColumn: formatTime(new Date(f.key[4])),
    xColumn_1: f.key[1],
    xColumn_2: f.key[2],
    xColumn_3: f.key[3],

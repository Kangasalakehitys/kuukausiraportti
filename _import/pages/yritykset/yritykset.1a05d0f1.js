...
// //Data
export const aly_pxt_11yq = (await FileAttachment({"name":"../../../data/stat/yritykset/aly_pxt_11yq.json","mimeType":"application/json","path":"../../../_file/data/stat/yritykset/aly_pxt_11yq.866c8af1.json","lastModified":1740068424388,"size":1754618}, import.meta.url)
            .json())
                .map(d => ({
                    ...d,
                    //AIka
